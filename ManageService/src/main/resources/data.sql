INSERT INTO  supplier(`id`,`active_flag`,`create_date`,`update_date`,`address`,`email`,`name`,`phone`)VALUES(1,1,"2021-06-13","2021-06-13","Quy nhơn, Bình định","redstart@gmail.com","Red Start","");
...
INSERT INTO  brand(`id`,`active_flag`,`create_date`,`update_date`,`name`,`description`)
VALUES(1,1,"2021-06-13","2021-06-13","Red Start","Cty TNHH Red Start");
